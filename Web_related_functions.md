...
# Timeouts
    ...
    setYimeout(func[,0]);                                       //this is used to execute the func right after the previous one is completed (that's why there is a differenc between nested setTimeout and setInterval time intervals)
